...
func main() {
	...
	switch mode {
	case "albert":
		chatMode(client, reader , &albertMessages)
	case "interview":
		interviewMode(client, reader,&interviewMessages)
	case "teach":
		teachMode(client, reader,&teachMessages)
	default:
...
func interviewMode(client *openai.Client, reader *bufio.Reader, messages *[]openai.ChatCompletionMessage) {
	fmt.Println("Chat mode started. Type 'exit' to quit.")
...
func teachMode(client *openai.Client, reader *bufio.Reader, messages *[]openai.ChatCompletionMessage) {
	fmt.Println("Chat mode started. Type 'exit' to quit.")
